...
const Faculty_Team = () => {
  return (
    <div className="mb-8 flex flex-col m-5 items-center justify-center text-gray-900">
      <h2 className="relative text-zinc-700 text-lg sm:text-3xl font-medium sm:font-semibold bg-gray-200 px-3 sm:px-4 mb-4 py-1 shadow-gray-600 tracking-wide shadow-md transition-all duration-500 hover:shadow-xl hover:shadow-gray-600 border-gray-200 border-1 z-10">
