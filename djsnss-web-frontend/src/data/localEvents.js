export const localEventsData = [
  {
    id: 1,
    title: "Mahim Beach Cleanup",
    description: "Restoring our shores",
    slug: "mahim-beach-cleanup",
    link: "/eventdetails/mahim-beach-cleanup",
    background: "bg-blue-500",
    imageURL: '',
    longDescription: "On 12th March 2024, the NSS unit of Dwarkadas J. Sanghvi College of Engineering organized a Mahim Beach Cleanup drive. The event aimed to restore the natural beauty of the beach and promote environmental awareness. Over 50 volunteers participated, collecting plastic waste and other debris. The cleanup drive not only helped in cleaning the beach but also educated participants on the importance of environmental conservation and waste management.",
    scale: "Area-Level",
    duration: "1 day",
    location: "Mahim Beach",
