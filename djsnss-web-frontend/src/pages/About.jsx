  ...
  return (
    <div className='flex flex-col bg-gradient-to-r pt-12 from-pink-200 to-blue-300 text-gray-800'>
      <div className="max-w-7xl mx-auto p-6 lg:p-12">
        ...
        >
          <div className="flex-shrink-0 w-32 h-32 md:w-40 md:h-40 lg:w-48 lg:h-48 bg-gray-200 rounded-full mb-4 lg:mb-0">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <div className="flex flex-col items-center">
              <div className="w-24 h-24 md:w-32 md:h-32 lg:w-40 lg:h-40 bg-gray-200 rounded-full mb-4">
                ...
                <img src="https://via.placeholder.com/150" alt="Core Team Member 1" className="w-full h-full object-cover rounded-full" />
              </div>
              <h3 className="text-lg md:text-xl lg:text-2xl font-semibold mb-2">Core Team Member 1</h3>
            ...
            <div className="flex flex-col items-center">
              <div className="w-24 h-24 md:w-32 md:h-32 lg:w-40 lg:h-40 bg-gray-200 rounded-full mb-4">
                {/* Placeholder for Core Team Member's Image */}
                <img src="https://via.placeholder.com/150" alt="Core Team Member 2" className="w-full h-full object-cover rounded-full" />
              </div>
              <h3 className="text-lg md:text-xl lg:text-2xl font-semibold mb-2">Core Team Member 2</h3>
              <p className="text-base md:text-lg lg:text-xl text-center">
            ...
            <div className="flex flex-col items-center">
              <div className="w-24 h-24 md:w-32 md:h-32 lg:w-40 lg:h-40 bg-gray-200 rounded-full mb-4">
                {/* Placeholder for Core Team Member's Image */}
                <img src="https://via.placeholder.com/150" alt="Core Team Member 3" className="w-full h-full object-cover rounded-full" />
              </div>
              <h3 className="text-lg md:text-xl lg:text-2xl font-semibold mb-2">Core Team Member 3</h3>
              <p className="text-base md:text-lg lg:text-xl text-center">
