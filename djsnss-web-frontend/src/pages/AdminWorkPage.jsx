      ...
      <div className="container p-auto mt-20 mx-auto p-4">
        ...
        {isCreating && (
          <form onSubmit={handleCreateSubmit} className="bg-white shadow-md rounded-lg p-6 mb-8">
            ...
            <div className="mb-4">
              <label htmlFor="eventImg" className="block text-gray-700 text-sm font-bold mb-2">
                Event Image URL
              </label>
              <input
                type="text"
            ...
            <div className="mb-4">
              <label htmlFor="eventDesc" className="block text-gray-700 text-sm font-bold mb-2">
                Event Description
              </label>
              <textarea
                id="eventDesc"
        ...
        {editEvent && (
          <form onSubmit={handleUpdate} className="bg-white shadow-md rounded-lg p-6 mb-8">
            <div className="mb-4">
              <label htmlFor="editEventName" className="block text-gray-700 text-sm font-bold mb-2">
                Event Name
              </label>
              <input
                type="text"
            ...
            <div className="mb-4">
              <label htmlFor="editEventImg" className="block text-gray-700 text-sm font-bold mb-2">
                Event Image URL
              </label>
              <input
                type="text"
            ...
            <div className="mb-4">
              <label htmlFor="editEventDesc" className="block text-gray-700 text-sm font-bold mb-2">
                Event Description
              </label>
              <textarea
                id="editEventDesc"
            ...
            <div className="mb-4">
              <label htmlFor="editEventDate" className="block text-gray-700 text-sm font-bold mb-2">
                Event Date
              </label>
              <input
                type="date"
            ...
            <button
              ...
              className="bg-gray-500 text-white font-bold py-2 px-4 rounded-lg hover:bg-gray-700 ml-2"
            >
              Cancel
            </button>
          </form>
            ...
            <div key={event._id} className="bg-white shadow-md rounded-lg overflow-hidden">
              ...
              <div className="p-4">
                ...
                <button
                  ...
                  className="bg-blue-500 text-white font-bold py-2 px-4 rounded-lg hover:bg-blue-700 mr-2"
                >
                  Edit
                </button>
                <button
